    ...
    function date_filter(type,value){
      $.ajax({
          ...
          data:"type="+type+"&value="+value,
            url:"<?php echo base_url()."admin/cd4_reports/cd4poc_date_filter_post"; ?>",  
      ...
      <td class="filter">
        <ul class="tabbed" id="">
          ...
          <li class="<?php 
                      ...
                      ?>">
            <span>&nbsp <a href="" onclick="date_filter('Yearly',<?php echo date("Y",strtotime($this-> session-> userdata('cd4_start_date'))); ?>)">All</a> &nbsp|</span>
          </li>
          <li class = "<?php 
