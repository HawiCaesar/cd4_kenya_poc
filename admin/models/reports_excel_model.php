...
class reports_excel_model extends MY_Model{
	...
	return $PHPExcel;
	 ...
	 function excel_year_month_all($YearM,$monthly,$all,$from_month,$end_month,$report_type,$county_name_value)
	 {
		...
		$PHPExcel[]=$this->excel->getActiveSheet()->getStyle('Q1')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
	 	...
	 	if($all==3 || $all==4 || $all==5)//By partner, by county, all data respectively
	 	{
	 		$this->load->model('reports_model');
			...
			{
				$county_id=$this->reports_model->get_county_id($county_name_value); //get the county name

				$PHPExcel[]=$this->excel->getActiveSheet()->setCellValue('A1','Report for '.$county_name_value.' County - '.$Month.', '.$YearM.' ' );
			}
			else if($all==5)
			{
	 ...
	 function excel_year_quarter_all($yearQ,$quarter,$all,$from_month,$end_month,$report_type,$county_name_value)
	 {
	 	$this->load->library('excel');//load excel library
		...
		$PHPExcel[]=$this->excel->getActiveSheet()->getStyle('Q1')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
	 	...
	 	if($all==3 || $all==4 || $all==5)//Get all data, or by  partner
	 	{
	 		...
	 		{	
				...
				$PHPExcel[]=$this->excel->getActiveSheet()->setCellValue('A1','Report for '.$county_name_value.' County - '.$quarter.', '.$yearQ.' ' );
	 		}
	 		else if($all==5)
	 		{
	 ...
	 function excel_year_biannual_all($yearB,$bian,$all,$from_month,$end_month,$report_type,$county_name_value)
	 {
	 	$this->load->library('excel');//load excel library
	 	$this->load->model('reports_model');
	 	$county_id="";
		...
		$PHPExcel[]=$this->excel->getActiveSheet()->getStyle('Q1')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
	 	...
	 	if($all==3 || $all==4 || $all==5)//Get all data, by Parnter
	 	{
			...
			else if($all==4)
			{
				...
				$PHPExcel[]=$this->excel->getActiveSheet()->setCellValue('A1','Report for '.$county_name_value.' County - '.$bian.', '.$yearB.' ' );
			}
			else if($all==5)
			{
	 ...
	 function excel_yearly_all($year,$all,$from_month,$end_month,$report_type,$county_name_value)
	 {
	 	$this->load->library('excel');//load excel library
	 	$county_id="";
		...
		$PHPExcel[]=$this->excel->getActiveSheet()->getStyle('Q1')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
	 	...
	 	if($all==3 || $all==4 || $all==5)//Get all data or by partner
	 	{
			...
			else if($all==4)
			{
				...
				$PHPExcel[]=$this->excel->getActiveSheet()->setCellValue('A1','Report for '.$county_name_value.' County - '.$year.' ' );
			}
			else if($all==5)
			{
	 ...
	 function excel_customized_dates_all($from_month,$end_month,$all,$report_type,$county_name_value)
	 {
	 	$this->load->library('excel');//load excel library
	 	$county_id="";
		...
		$PHPExcel[]=$this->excel->getActiveSheet()->getStyle('Q1')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
	 	...
	 	if($all==3 || $all==4 || $all==5)//by partner, by county, all data
	 	{
	 		...
	 		{	
				...
				$PHPExcel[]=$this->excel->getActiveSheet()->setCellValue('A1','Report for '.$county_name_value.' County - Between '.$from_month.' and '.$end_month.' ' );
	 		}
	 		else if($all==5)
	 		{
	...
	function excel_tests_lessthan350_month($YearM,$monthly,$facility,$device,$from_month,$end_month,$report_type,$all,$county_name_value)
	{
		 	$this->load->library('excel');
	...
	/*=================== Excel: Less than 350 - By Quarter =========================================*/
 	...
 	function excel_tests_lessthan350_quarter($yearQ,$quarter,$facility,$device,$from_month,$end_month,$report_type,$all,$county_name_value)
	{
		 	$this->load->library('excel');
		...
		function excel_tests_lessthan350_bian($yearB,$biannual_name,$facility,$device,$from_month,$end_month,$report_type,$all,$county_name_value)
		 {
		 	$this->load->library('excel');
			...
			{	
		 	...
		 	{		 	
				...
				else if($all==4)
				{
					...
					$PHPExcel[]=$this->excel->getActiveSheet()->setCellValue('A1','Report for '.$county_name_value.' County  - '.$biannual_name.','.$yearB.' ' );
				}
				else if($all==5)
				{
		...
		function excel_tests_lessthan350_yearly($YearO,$facility,$device,$from_month,$end_month,$report_type,$all,$county_name_value)
		 {
		 	$this->load->library('excel');
			...
			{	
		 	...
		 	{				
				...
				else if($all==4)
				{
					...
					$PHPExcel[]=$this->excel->getActiveSheet()->setCellValue('A1','Report for '.$county_name_value.' County  - '.$YearO.' ' );
				}
				else if($all==5)
				{
		...
		function excel_tests_lessthan350_customized($facility,$device,$Fromdate,$Todate,$report_type,$all,$county_name_value)
	 	{
		 	$this->load->library('excel');
			...
			if($all==3 || $all==4 || $all==5)//by parnter, county, all data
			{
				$PHPExcel[]=$this->excel->getActiveSheet()->setCellValue('D2','Device');
				$PHPExcel[]=$this->excel->getActiveSheet()->getStyle('D2')->getFont()->setSize(12);
				$PHPExcel[]=$this->excel->getActiveSheet()->getStyle('D2')->getFont()->setBold(true);
			...
			{	
		 	...
		 	if($all==3 || $all==4 || $all==5)
		 	{
				...
				else if($all==4)
				{
					...
					$PHPExcel[]=$this->excel->getActiveSheet()->setCellValue('A1','Report for '.$county_name_value.' County  - Between '.$Fromdate.' and '.$Todate.' ' );
				}
				else if($all==5)
				{
				...
				$sql_data=$this->excel_tests_details_all($Fromdate,$Todate,$all,$report_type,$county_id);
		...
		public function excel_tests_details_all($from,$to,$all,$report_type,$county_id)//Get all the data or by county
		{
			...
			// echo $tests_sql.$date_delimiter.$delimiter.$report_type;
			// die;
